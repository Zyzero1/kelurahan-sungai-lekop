        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">Tambah Media Sosial</h3>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('platform') is-invalid @enderror" 
                                        id="platform" name="platform" value="{{ old('platform') }}" required>
                                    @error('platform')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('icon_class') is-invalid @enderror" 
                                        id="icon_class" name="icon_class" value="{{ old('icon_class') }}" required
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('color_class') is-invalid @enderror" 
                                        id="color_class" name="color_class" value="{{ old('color_class') }}" required
